...
public class SimpleTests {
	public static void main(String[] args) {
		...
		System.out.println("Fuel is " + b.getFuel() + " excpected 10.0.");
		
		
		
		//testing gettankCapacity() and setMaxBurnRate()
		System.out.println("\nTest 2:");
		...
		b.setMaxBurnRate(2);
		System.out.println("Max fuel burn rate is " + b.getMaxBurnRate() + " expected 2.0.");
		
		
		// Testing adjustVerticalVelocity() and getVerticalVelocity() and adjustHorizontalVelocity() and getHorizontalVeloctiy()
		System.out.println("\nTest 3:");
		...
		//Testing getHours() getMinutes() and getSeconds()
		System.out.println("\nTest 4:");
		...
		//Testing oneSecondUpdate() getGroundPosition()
		System.out.println("\nTest 5:");
		...
		//My own tests. restoreIntialGroundPosition()
		System.out.println("Current ground position " + b.getGroundPosition());
		b.restoreInitialGroundPosition();
		System.out.println("New ground position " + b.getGroundPosition() + " expected 37");
